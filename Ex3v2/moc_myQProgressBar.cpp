/****************************************************************************
** Meta object code from reading C++ file 'myQProgressBar.h'
**
...
#error "The header file 'myQProgressBar.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 35, 8) // "setValue"
    ...
    "myQProgressBar\0valueChanged\0\0value\0"
    "setValue"
};
...
void myQProgressBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<myQProgressBar *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (myQProgressBar::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myQProgressBar::valueChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject myQProgressBar::staticMetaObject = { {
...
const QMetaObject *myQProgressBar::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *myQProgressBar::qt_metacast(const char *_clname)
{
...
int myQProgressBar::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void myQProgressBar::valueChanged(int _t1)
{
